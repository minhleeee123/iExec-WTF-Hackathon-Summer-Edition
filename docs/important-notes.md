...
- Optimized frontend deployment `dpl_8dW2gjqFQ6HJ6taKtq2mst2U6Uv8` is READY and aliased to `https://noxswap-iexec.vercel.app`; all primary routes returned HTTP 200, and production browser smoke at 1280×900 and 390×844 loaded four real Safe orders without a wallet, preserved the Safe owner filter, and showed no document or orderbook overflow.

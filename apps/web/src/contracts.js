...
export const SAFE_MODULE_ABI = [
  ...
  'function consumedInput(bytes32 handle) view returns (bool)',
  ...
  'function prepareAndSwap(address tokenIn,address tokenOut,bytes32 encryptedAmountIn,bytes inputProof,bytes32 encryptedMinOut,bytes minOutProof,address inputOwner,address receiptOwner,uint64 deadline) returns (bytes32 encryptedOutput,bytes32 encryptedRefund,uint256 receiptId)',
  'function prepareAndCreateLimitOrder(address tokenIn,address tokenOut,bytes32 encryptedAmountIn,bytes inputProof,bytes32 encryptedMinOut,bytes minOutProof,address inputOwner,address receiptOwner,uint256 triggerPrice,uint64 expiry) returns (uint256 orderId)',
  'function prepareAndRequestUnwrap(address token,bytes32 encryptedAmount,bytes inputProof,address inputOwner,address recipient) returns (bytes32 unwrapRequestId)',

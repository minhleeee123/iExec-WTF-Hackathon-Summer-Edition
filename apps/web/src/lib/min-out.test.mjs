...
test('derives a protected USDC to ETH minimum with the default ten-percent oracle tolerance', () => {
...
test('derives protected limit-order minimums with the default ten-percent tolerance', () => {
  assert.equal(deriveLimitOrderMinOut({ amount: '100', outputDecimals: 18, side: 'buy', triggerPrice: '2000' }), '0.044865');
  assert.equal(deriveLimitOrderMinOut({ amount: '0.05', outputDecimals: 6, side: 'sell', triggerPrice: '2000' }), '89.73');

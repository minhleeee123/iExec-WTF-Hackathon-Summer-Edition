  ...
  return (
    <div className="order-form public-order-form">
      ...
      <div className="order-fields">
        ...
        <label><span>Oracle tolerance</span><span className="protected-input"><select value={protectionBps} onChange={(event) => onProtectionChange(Number(event.target.value))} aria-label="Limit order oracle tolerance"><option value={50}>0.5%</option><option value={100}>1%</option><option value={300}>3%</option><option value={500}>5% — recommended</option><option value={1000}>10%</option></select><strong>buffer</strong></span></label>

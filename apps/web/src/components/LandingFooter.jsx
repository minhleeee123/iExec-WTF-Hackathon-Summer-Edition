...
const safeFactoryExplorerUrl = `https://sepolia.etherscan.io/address/${deployment.safe.factory}`;
  ...
  return (
    <footer className="landing-footer">
      ...
      <nav aria-label="Project resources">
        ...
        <a href={safeFactoryExplorerUrl} target="_blank" rel="noreferrer">Safe factory <ExternalLink size={14} /></a>

...
export default function AclSection({ aclResult, auditor, busy, connected, embedded = false, onAuditorChange, onGrant, shareLink }) {
  return (
    <section className={`section-band acl-band${embedded ? ' embedded-workflow' : ''}`}>
      ...
      {shareLink && <a className="acl-share-link" href={shareLink}>Open the viewer page for this wallet</a>}
    </section>
  );
}

...
| Responsive UI | Production build plus 41 frontend unit tests and headless Chrome at `1440x1000` and `390x844`; validates EIP-6963 wallet selection, Strategy Agent, public orderbook/detail, operator revoke visibility, URL persistence, owner/non-owner controls, landing/app separation, desktop sidebar, mobile wallet drawer, bottom navigation, and observer endpoint auth/rate/body guards | PASS |
